    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <nav className="bg-slate-900/60 border-b border-white/10 backdrop-blur-xl">
        <div className="container mx-auto flex items-center justify-between p-4">
          <h1 className="text-xl font-bold text-brand-400">Pulse-Up</h1>
          <div className="flex gap-6">
            <Link to="/" className="hover:text-amber-200 ">Home</Link>
            <Link to="/exercises" className="hover:text-amber-200">Exercises</Link>
            <Link to="/my-workouts" className="hover:text-amber-200">My Workouts</Link>
